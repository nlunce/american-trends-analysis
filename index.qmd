...
# Title and labels
plt.title(r"Annual CO2 Emissions from Fossil Fuels in the United States (2001 - 2024)", fontsize=18, weight='bold', pad=20)
plt.xlabel("Year", fontsize=14, weight='bold')
plt.ylabel(r"CO2 Emissions (Million Metric Tons)", fontsize=14, weight='bold')
